...
if biggestPoints.size != 0 and gradePoints.size != 0:
    ...
    cv2.putText(imgRawGrade, str(int(score)) + "%", (70, 100) , cv2.FONT_HERSHEY_COMPLEX, 3.5, (100, 105, 255), 10)  # ADD THE GRADE TO NEW IMAGE
    invMatrixG = cv2.getPerspectiveTransform(ptsG2, ptsG1)  # INVERSE TRANSFORMATION MATRIX
    imgInvGradeDisplay = cv2.warpPerspective(imgRawGrade, invMatrixG, (widthImg, heightImg))  # INV IMAGE WARP adding grade to original image
